(function () {
    ...
    function getweatherImage(response) {
        ...
        let iconURL = "static/images/icons/" + iconCode + ".png";
        ...
        switch (iconCode) {
            case "01d":
                if (temp < -1) {
                    mainImageUrl = "static/images/illustrations/cold.png";
                } else {
                    mainImageUrl = "static/images/illustrations/sunny.png";
                }
                changeImage();
                break;
            case "01n":
                if (temp < -1) {
                    ...
                    mainImageUrl = "static/images/illustrations/night.png";
                }
                changeImage();
                break;
            case cloudyIcons[0]:
            ...
            case cloudyIcons[5]:
                if (temp < -1) {
                    ...
                    mainImageUrl = "static/images/illustrations/cloudy.png";
                }
                changeImage();
                break;
            case rainyIcons[0]:
            ...
            case rainyIcons[2]:
            case rainyIcons[3]:
                mainImageUrl = "static/images/illustrations/rain.png";
                changeImage();
                break;
            case thunderIcons[0]:
            case thunderIcons[1]:
                mainImageUrl = "static/images/illustrations/thunder.png";
                changeImage();
                break;
            case snowIcons[0]:
            case snowIcons[1]:
                mainImageUrl = "static/images/illustrations/snow.png";
                changeImage();
                break;
            case mistIcons[0]:
            case mistIcons[1]:
                if (temp < -1) {
                    ...
                    mainImageUrl = "static/images/illustrations/misty.png";
                }
                changeImage();
                break;
        }
...
<div class="col-3">
    ...
    <img class="weather-icon" src="static/images/icons/${forecast.weather[0].icon}.png" alt="sun">
